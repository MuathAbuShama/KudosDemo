...
(function ($) {
  ...
  $.fn.setVideoBgSize = function (hh, wh) {
    ...
    setTimeout(function () {
      ...
      if (
        newWidth / vidW > 1 &&
        (($(window).width() < newWidth && vidH < cH) || $(window).width() < 769)
      ) {
  ...
  $(document).ready(function () {
    ...
    $("body").on("click", "[data-toggle='dropdown']", function () {
      ...
      if (!isEmpty(href) && href.length > 5 && !href.startsWith("#"))
    ...
    $(".scroll-content").executeFunction("slimScroll", function () {
      ...
      $(".scroll-content").on("mousewheel DOMMouseScroll", function (n) {
        n.preventDefault();
      });
      $(".scroll-content")
        .slimScroll()
